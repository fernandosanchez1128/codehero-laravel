...
('27s2','27','San Jose'),
('27s3','27','Concentracion de Desarrollo Rural'),
...
('28s11','28','Romulo Rengifo'),
('28s12','28','Rosa Sarate De Peña'),
('28s13','28','Sagrado Corazon De Jesus'),
('28s14','28','San Isidro'),
('28s15','28','San Jorge'),
('28s16','28','San Juan Bosco'),
('28s17','28','San Martin De Porres'),
('28s18','28','San Pablo'),
('28s19','28','Simon Bolivar'),
...
('33sp','33','SP : Gilberto Alzate Avendaño'),
('33s1','33','Fabio Martinez Cifuentes'),
('33s2','33','Manuel Mejia Velez'),
